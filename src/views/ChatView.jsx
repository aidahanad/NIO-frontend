...
const SUGGESTIONS = [
  'Quelles sont les dernières réglementations pétrolières en Algérie ?',
  'Analyse ce contrat de fourniture de carburant.',
  'Explique la procédure de conformité HSE.',
  'Résume les obligations légales de Naftal.',
]
